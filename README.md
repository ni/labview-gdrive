...
i. Which API are you using? : Google Drive API  
ii. Where will you be calling the API from?: Other UI  
iii. What data will you be using?: User Data  
iv. Then, click “What credentials do I need?”  
